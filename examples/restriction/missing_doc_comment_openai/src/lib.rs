...
pub fn register_lints(sess: &Session, lint_store: &mut LintStore) {
    ...
    lint_store.register_lints(&[MISSING_DOC_COMMENT_OPENAI]);
    lint_store.register_late_pass(move |_| Box::new(MissingDocCommentOpenai::new()));
...
impl_lint_pass!(MissingDocCommentOpenai => [MISSING_DOC_COMMENT_OPENAI]);
