...
// https://github.com/rust-lang/cargo/blob/16ad1f2945dff5c7f3234257d5ab477ea86b7338/src/cargo/util/canonical_url.rs
...
///
/// A "canonical" url is only intended for internal comparison purposes in Cargo. It's to help
/// paper over mistakes such as depending on `github.com/foo/bar` vs `github.com/foo/bar.git`. This
/// is **only** for internal purposes within Cargo and provides no means to actually read the
...
impl CanonicalUrl {
    ...
    /// used/displayed/etc, it should only be used for internal data structures and hashes and
    /// such.
