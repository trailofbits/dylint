...
use not_windows::{default_linker, output_path};
...
mod windows {
    ...
    use dylint_internal::{env, rustup::parse_toolchain};
    use std::{
        ffi::OsStr,
        fs::File,
        io::Read,
    ...
    pub(super) fn needs_lld_link_flavor(linker: &Path) -> bool {
    ...
    pub(super) fn output_path<'a, I>(iter: I) -> Result<Option<PathBuf>>
    where
    ...
    fn extract_out_path_from_linker_response_file(
